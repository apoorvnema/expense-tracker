...
async function handleAddExpense(e) {
    ...
    try {
        ...
        await axios.post("https://expense-tracker.apoorvnema.com/expense/add-expense", expenseDetails, { headers: { "Authorization": token } });
...
async function handleDeleteExpense(btn) {
    try {
        btn.addEventListener("click", async () => {
            await axios.delete(`https://expense-tracker.apoorvnema.com/expense/delete-expense/${btn.parentElement.parentElement.id}`, { headers: { "Authorization": token } })
            window.location.reload();
        });
    }
    catch (err) {
...
async function handleGetExpense(page) {
    ...
    try {
        const getExpense = await axios.get(`https://expense-tracker.apoorvnema.com/expense/getExpensePerPage?page=${page}&items_per_page=${itemsPerPage}`, { headers: { "Authorization": token } })
...
async function buyPremium() {
    try {
        const response = await axios.get('https://expense-tracker.apoorvnema.com/purchase/premiummembership', { headers: { "Authorization": token } })
        var options = {
            "key": response.data.key_id,
            "_id": response.data.order._id,
            "orderId": response.data.order.orderId,
            "handler": async function (response) {
                await axios.post("https://expense-tracker.apoorvnema.com/purchase/updatetransactionstatus", {
                    _id: options._id,
        ...
        rzp1.on('payment.failed', async function (response) {
            await axios.post("https://expense-tracker.apoorvnema.com/purchase/failedtransactionstatus", {
                _id: options._id,
                paymentId: response.razorpay_payment_id,
            }, { headers: { "Authorization": token } })
...
async function premiumLeaderboard() {
    try {
        ...
        const getLeaderboard = await axios.get("https://expense-tracker.apoorvnema.com/premium/leaderboard", { headers: { "Authorization": token } });
...
async function premiumGenerateReport() {
    try {
        ...
        const getReport = await axios.get("https://expense-tracker.apoorvnema.com/premium/report", { headers: { "Authorization": token } })
...
async function premiumDownloadReport() {
    try {
        axios.get("https://expense-tracker.apoorvnema.com/premium/download-report", { headers: { "Authorization": token } })
            .then(result => {
